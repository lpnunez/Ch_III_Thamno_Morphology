...
load("Results/slid_coords.RData")
...
write.csv(phypca_test$x, "Results/Skull_PhyPCA_PC.csv")
write.csv(paca_test$x, "Results/Skull_PACA_PC.csv")
...
write.csv(phypca_premax$x, "Results/Premaxilla_PhyPCA_PC.csv")
write.csv(paca_premax$x, "Results/Premaxilla_PACA_PC.csv")
...
write.csv(phypca_Nasal$x, "Results/Nasal_PhyPCA_PC.csv")
write.csv(paca_Nasal$x, "Results/Nasal_PACA_PC.csv")
...
write.csv(phypca_Frontal$x, "Results/Frontal_PhyPCA_PC.csv")
write.csv(paca_Frontal$x, "Results/Frontal_PACA_PC.csv")
...
write.csv(phypca_Parietal$x, "Results/Parietal_PhyPCA_PC.csv")
write.csv(paca_Parietal$x, "Results/Parietal_PACA_PC.csv")
...
write.csv(phypca_Supraocc$x, "Results/Supraoccipital_PhyPCA_PC.csv")
write.csv(paca_Supraocc$x, "Results/Supraoccipital_PACA_PC.csv")
...
write.csv(phypca_Basi$x, "Results/Basisphenoid_PhyPCA_PC.csv")
write.csv(paca_Basi$x, "Results/Basisphenoid_PACA_PC.csv")
...
write.csv(phypca_Maxilla$x, "Results/Maxilla_PhyPCA_PC.csv")
write.csv(paca_Maxilla$x, "Results/Maxilla_PACA_PC.csv")
...
write.csv(phypca_Palatine$x, "Results/Palatine_PhyPCA_PC.csv")
write.csv(paca_Palatine$x, "Results/Palatine_PACA_PC.csv")
...
write.csv(phypca_Ecto$x, "Results/Ectopterygoid_PhyPCA_PC.csv")
write.csv(paca_Ecto$x, "Results/Ectopterygoid_PACA_PC.csv")
...
write.csv(phypca_Pterygoid$x, "Results/Pterygoid_PhyPCA_PC.csv")
write.csv(paca_Pterygoid$x, "Results/Pterygoid_PACA_PC.csv")
...
write.csv(phypca_Dentary$x, "Results/Dentary_PhyPCA_PC.csv")
write.csv(paca_Dentary$x, "Results/Dentary_PACA_PC.csv")
...
write.csv(phypca_Compound$x, "Results/Compound_PhyPCA_PC.csv")
write.csv(paca_Compound$x, "Results/Compound_PACA_PC.csv")
...
write.csv(phypca_Quadrate$x, "Results/Quadrate_PhyPCA_PC.csv")
write.csv(paca_Quadrate$x, "Results/Quadrate_PACA_PC.csv")
...
write.csv(phypca_Supratemp$x, "Results/Supratemporal_PhyPCA_PC.csv")
write.csv(paca_Supratemp$x, "Results/Supratemporal_PACA_PC.csv")
...
write.csv(phypca_Snout$x, "Results/Snout_PhyPCA_PC.csv")
write.csv(paca_Snout$x, "Results/Snout_PACA_PC.csv")
...
write.csv(phypca_Braincase$x, "Results/Braincase_PhyPCA_PC.csv")
write.csv(paca_Braincase$x, "Results/Braincase_PACA_PC.csv")
...
write.csv(phypca_Palatoptery$x, "Results/Palatopterygoid_Arch_PhyPCA_PC.csv")
write.csv(paca_Palatoptery$x, "Results/Palatopterygoid_Arch_PACA_PC.csv")
...
write.csv(phypca_Mandible$x, "Results/Mandible_PhyPCA_PC.csv")
write.csv(paca_Mandible$x, "Results/Mandible_PACA_PC.csv")
...
write.csv(phypca_Suspensorium$x, "Results/Suspensorium_PhyPCA_PC.csv")
write.csv(paca_Suspensorium$x, "Results/Suspensorium_PACA_PC.csv")
